...
function processData(html) {
    ...
    for(let i = 0 ; i < bothInnings.length; i++) {
        ...
        let allTrs = oneInnings.find("table.ds-w-full.ds-table.ds-table-md.ds-table-auto.ci-scorecard-table tbody tr");
        ...
        for(let j = 0 ; j < allTrs.length; j++) {
            ...
            if(allTds.length > 1) {
                ...
                // processDeatials(batsmanName , runs , balls , fours , sixes , strikeRate);
            }
        }
    }
    console.log("------------------------------>");
...
// function processDeatials(batsmanName , runs , balls , fours , sixes , strikeRate) {
